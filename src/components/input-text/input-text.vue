...
<template>
  <div class="relative text-secondary-600 hover:text-secondary-700 focus:text-secondary-900">
    ...
    "
      v-bind="$attrs"
    />
    <div v-if="props.iconRight" class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
